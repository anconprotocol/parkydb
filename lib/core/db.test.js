...
ava_1.default('put', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const { db } = t.context;
    const id = yield db.putBlock(payload);
    const res = yield db.get(id, null);
    const q = yield db.query({
        cid: id,
        query: `
    query{
       block(cid: "${id}") {
