...
const ed25519keyring_1 = require("../wallet/ed25519keyring");
...
class ParkyDB {
    ...
    async addEd25519(keys) {
        return this.keyringController.keyringController.addNewKeyring(ed25519keyring_1.Ed25519.type, keys);
    }
    async addSecp256k1(keys) {
        return this.keyringController.keyringController.addNewKeyring(simple_1.Simple.type, keys);
    }
