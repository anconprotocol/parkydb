...
class ParkyDB {
    ...
    async createChannelPubsub(topic, options) {
        ...
        return this.messagingService.createChannel(topic, { ...options, sigkey: h, encryptionPubKey: (0, utils_1.hexlify)(pubkey) }, this.db.onBlockCreated);
    }
    async aggregate(topic, options) {
        ...
        return this.messagingService.aggregate(topic, {
            ...options,
            sigkey: h,
            encryptionPubKey: (0, utils_1.hexlify)(pubkey),
        });
    }
