...
class WebauthnHardwareAuthenticate {
    ...
    async signData(origin, credential, challenge, payload, uid, emitPublicKey) {
        ...
        try {
            ...
            const clientDataJSON = parser_1.parseClientResponse(clientAssertion);
            const authenticatorData = parser_1.parseAuthenticatorData(clientAssertion.response.authenticatorData);
            return {
                clientDataJSON,
                authenticatorData,
