...
const StorageKind_1 = require("../parkydb-interfaces/interfaces/StorageKind");
let StorageAssetArgs = class StorageAssetArgs {
};
__decorate([
    (0, type_graphql_1.Field)((type) => type_graphql_1.Int, { defaultValue: 10, nullable: true }),
...
__decorate([
    (0, type_graphql_1.Query)((returns) => StorageKind_1.StorageAsset),
